...
{
	public static readonly ulong[] Roles =
	{
		700030554002817095,
		686537799419035668,
		686537766296879115,
	...
	public static readonly MessageProperties WelcomeProperties = new()
	{
		...
		Components = new ComponentBuilder()
			.WithSelectMenu("welcome_category", new List<SelectMenuOptionBuilder>(new[]
			{
				...
				new SelectMenuOptionBuilder().WithLabel("🗺️Карта сервера").WithDescription("гайд по серверу")
					.WithValue("map"),
				new SelectMenuOptionBuilder().WithLabel("🤖Команды").WithDescription("команды ботов").WithValue("bots"),
				new SelectMenuOptionBuilder().WithLabel("💰Донат").WithDescription("поддержка сервера")
					.WithValue("donate")
			}))
			.Build()
	};
	...
	public static readonly MessageProperties RolesProperties = new()
	{
		Embeds = new[]
		{
			new EmbedBuilder()
				.WithColor(3092790)
				.WithImageUrl(
					"https://cdn.discordapp.com/attachments/689528587917066282/1089493517727977582/game-role.png")
				.Build(),
			new EmbedBuilder()
				.WithColor(3092790)
				.WithDescription(
					"Вы можете получить игровые роли, которые помогут вам найти тиммейтов. Для этого выберите их из списка ниже.")
				.Build()
		},
	...
	public static readonly MessageProperties MapProperties = new()
	{
		Embeds = new[]
		{
			new EmbedBuilder()
				.WithColor(3093046)
				.WithImageUrl(
					"https://media.discordapp.net/attachments/687379079229341766/700817559909564565/roles.png?width=1368&height=683")
				.Build(),
			new EmbedBuilder()
				.WithColor(3093046)
			...
			new EmbedBuilder()
				...
				.WithDescription(
					"⠀⠀ <@&542016825219612672> — люди, заслужившие доверие." +
	...
	public static readonly MessageProperties DonateProperties = new()
	{
		Embeds = new[]
		{
			new EmbedBuilder()
				.WithColor(3093046)
				.WithImageUrl(
					"https://media.discordapp.net/attachments/696783977004138627/804014503809253416/podderzhka.png")
				.Build(),
			new EmbedBuilder()
				.WithColor(3093046)
				.WithTitle("<a:znak:781849766816120852> Поддержка Friendly team'a")
				.WithDescription(
					"Мы обещаем, что ваши деньги пойдут на развитие сервера. Чтобы повышать актив и на рекламу." +
